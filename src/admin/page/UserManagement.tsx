...
import { X, ChevronRight, Search, Filter, Bell, Menu, ChevronLeft } from 'lucide-react';
...
const UserManagement = () => {
  ...
  const filteredUsers = users.filter(user => {
    ...
    const matchesSuspended = showSuspended ? user.isSuspended : !user.isSuspended;
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'Vendor': return 'text-green-700';
      case 'Rider': return 'text-green-800';
        ...
        <div className="min-h-screen bg-gray-50 animate-fadeIn">
          ...
          <div className="px-4 py-6">
            ...
            <div className="flex flex-col items-center mb-6 animate-slideUp">
              ...
              <p className="text-green-700 font-semibold mt-1">{selectedUser.phone}</p>
            </div>

            {/* Personal Information Section */}
            <div className="mb-6">
              <h3 className="text-green-700 font-bold text-lg mb-4">Personal information</h3>
              ...
              <div className="bg-white rounded-xl p-4 mb-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start">
                  ...
                  <button
                    onClick={() => editingField === 'fullName' ? handleSaveField() : handleEditField('fullName')}
              ...
              <div className="bg-white rounded-xl p-4 mb-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start">
                  ...
                  <button
                    onClick={() => editingField === 'email' ? handleSaveField() : handleEditField('email')}
                    className="ml-4 px-4 py-1.5 bg-green-600 text-white text-sm rounded-lg hover:bg-green-700 transition-all transform hover:scale-105"
                  >
              ...
              <div className="bg-white rounded-xl p-4 mb-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start">
                  ...
                  <button
                    onClick={() => editingField === 'phone' ? handleSaveField() : handleEditField('phone')}
                    className="ml-4 px-4 py-1.5 bg-green-600 text-white text-sm rounded-lg hover:bg-green-700 transition-all transform hover:scale-105"
                  >
                  ...
                  <div>
                    ...
                    {editingField === 'zip' ? (
                      <input
                        ...
                        onChange={(e) => setEditValues({ ...editValues, zip: e.target.value })}
        ...
        <div className="px-4 py-3 bg-white border-t border-b border-gray-200">
          ...
          >
            <span className="text-gray-700 font-medium">
              Suspended account <span className="text-gray-500">({suspendedCount})</span>
            </span>
        ...
        {filteredUsers.map((user, index) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-gray-700 font-medium">{index + 1}. {user.name}</p>
              </div>
            </div>
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <div className="flex-1 text-center">
                    <h2 className="text-xl font-bold text-gray-900">Mardiya Kitchen</h2>
                    <p className={`text-sm font-semibold mt-1 ${getTypeColor(selectedUser.type)}`}>
                      {selectedUser.type}
                    </p>
                  </div>
                  <button 
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full py-4 px-4 bg-white border border-gray-200 rounded-xl flex items-center justify-between hover:bg-gray-50 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                  >
                    <span className="text-gray-700 font-medium">Suspend {selectedUser.type}</span>
                    <ChevronRight className="w-5 h-5 text-gray-400" />
                  </button>

                  <div className="py-3 px-4 bg-gray-50 rounded-xl">
                    <p className="text-sm text-gray-500">Date joined</p>
                    <p className="text-sm text-gray-900 mt-1">{selectedUser.dateJoined}</p>
                  </div>
                  ...
                  >
                    <span className="text-red-500 font-semibold">Delete {selectedUser.type}</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          {modalType === 'suspend' && selectedUser && (
            ...
            >
              ...
              <div className="text-center mb-8">
                <h2 className="text-xl font-bold text-gray-900 mb-1">Mardiya Kitchen</h2>
                <p className={`text-sm font-semibold ${getTypeColor(selectedUser.type)}`}>
                  {selectedUser.type}
                </p>
              </div>
