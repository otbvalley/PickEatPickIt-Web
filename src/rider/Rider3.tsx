  ...
  return (
    <>
      ...
      <div>
        ...
        {/* welcom */}
        <div className="max-w-[300px] max-h-[153px] mx-auto animate-bounce mt-[50px] shadow-lg shadow-[white] rounded-[10px] p-4">
          <img src={welCat} alt="" className="object-cover" />
        </div>
        {/* cart welcome image */}
        {/* welcome text */}
        <p className="max-w-[340px] text-center text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] text-[#7A7A7A] font-sans  font-semibold mx-auto mt-[10rem] ">
